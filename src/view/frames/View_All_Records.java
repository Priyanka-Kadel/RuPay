...
public class View_All_Records extends javax.swing.JFrame {
    ...
    public void setRecordsToTable(){
        try{
            ...
            while(rs.next()){
                ...
                Object[] obj = {receiptNo,studentName,courseName,amount,paymentMode,date,remark};
    ...
    private void initComponents() {
        ...
        view_all_records.setBackground(new java.awt.Color(214, 173, 87));
        view_all_records.setForeground(new java.awt.Color(65, 65, 65));
        ...
        Add_fees.setText("View All Records");
        ...
        tbl_studentdata.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reciept No", "Student Name", "Course Name", "Amount", "Payment Mode", "Date", "Remarks"
            }
        ));
        tbl_studentdata.setRowHeight(40);
        jScrollPane1.setViewportView(tbl_studentdata);

        inner_panel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 137, 1080, 630));
