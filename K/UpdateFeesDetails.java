...
public class UpdateFeesDetails extends javax.swing.JFrame {
    ...
    public String updateData(){
        ...
        try {
            Connection con= DBConnection.getConnection();
            String query=("update fees_detail set student_name=?,payment_mode=?,cheque_no=?,bank_name=?,course_name=?,gstin=?,total_amount=?,date=?,amount=?,vat=?,scholarship=?,total_in_words=?,remark=?,year1=?,year2=? where reciept_no=?");
            PreparedStatement statement = con.prepareStatement(query);
            statement.setString(1,studentName);
            statement.setString(2,paymentMode);
            statement.setString(3,chequeNo);
            statement.setString(4, bankName);
            statement.setString(5, courseName);
            statement.setString(6,gstin);
            statement.setFloat(7, totalAmount);
            statement.setString(8, date);
            statement.setFloat(9, initialAmount);
            statement.setFloat(10,vat);
            statement.setFloat(11, scholarship);
            statement.setString(12, totalInWords);
            statement.setString(13, remark);
            statement.setInt(14,year1);
            statement.setInt(15, year2);
            statement.setInt(16, recieptNo);
    ...
    public void setRecords(){
        try {
            ...
            txt_sc_amt.setText(rs.getString("scholarship"));
    ...
    public static void main(String args[]) {
        UpdateFeesDetails object= new UpdateFeesDetails();
        object.cash();
